...
def parse_args(args):
    ...
    if args['exp_type'] == 'overfit':
        args['synth_train_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_overfitting.txt")
        args['synth_val_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_overfitting.txt")
        args['real_train_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_overfitting.txt")
        args['real_val_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_overfitting.txt")
        ...
        args['synth_train_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_train.txt")
        args['synth_val_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_val.txt")
        args['real_train_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_train2.txt")
        args['real_val_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_val2.txt")
        ...
        args['synth_train_file'] = args.get('synth_train_file', os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_all.txt"))
        args['synth_val_file'] = args.get('synth_val_file', os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/synth_val.txt"))
        args['real_train_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_train.txt")
        args['real_val_file'] = os.path.join(BASE_PATH, "BodyPressure/BodyMAP/data_files/real_val.txt")
        args['epochs'] = args.get('epochs', 100)
    else:
